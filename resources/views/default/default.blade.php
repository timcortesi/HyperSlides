...
<html lang="en">
  <head>
    ...
    <title>@yield('title') | HyperSlides</title>
    <!-- Bootstrap -->
  ...
  <body class="login">
      ...
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="/" style="background: rgb(51, 85, 136);color:white;padding: 0px 0px 0px 25px;">
            <h3 style="color:#fff;margin-top:12px;"><i class="fa fa-address-book"></i> HyperSlides</h3>
          </a>
        </div>
    ...
    padding: 5px 20px;">
    <i class="far fa-copyright fa-fw"></i> {{ now()->year }} Tim Cortesi</a>&nbsp;|
    <a style="color:#555;" href="https://github.com/timcortesi/HyperSlides"><i class="fab fa-github fa-lg fa-fw"></i>&nbsp;Github</a>&nbsp;|
    <a style="color:#555;" href="mailto:tcortesi@gmail.com"><i class="fa fa-envelope fa-lg fa-fw"></i>&nbsp;Contact</a>
    </div>
    </footer>
    <!-- Footer -->
